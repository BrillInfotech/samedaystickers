<div class="content">
		<!-- BEGIN LOGIN FORM -->
		 <?php echo $this->Form->create('User', array('url'=>array('plugin'=>'backend','controller'=>'users', 'action'=>'login'), 'class'=>'form-vertical login-form'));?>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<?php echo $this->Form->text('User.username', array('class'=>'m-wrap placeholder-no-fix', 'placeholder'=>'Username', 'autocomplete'=>'off'));?>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<?php echo $this->Form->input('User.password', array('type'=>'password','class'=>'m-wrap placeholder-no-fix', 'placeholder'=>'Password', 'autocomplete'=>'off', 'div'=>false, 'label'=>false));?>
					</div>
				</div>
			</div>
