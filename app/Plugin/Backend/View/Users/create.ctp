					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo (!empty($user_id)?'Edit User':'Add New User'); ?></div>
								 <div class="tools"><?php echo $this->Html->link('<i class="icon-circle-arrow-left"></i> Back', array('controller'=>'users', 'action'=>'index'), array('div'=>false, 'escape'=>false, 'style'=>'color:#fff; font-weight:bold;'));?></div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
							     <?php echo $this->Form->create('User', array('url'=>array('controller'=>'users', 'action'=>'create', $user_id), 'id'=>'form_sample_2', 'class'=>'form-horizontal','type'=>'file')); ?>
								 <?php echo $this->Form->hidden('User.id');?>
									...
									<div class="control-group">
										...
										<div class="controls">
												 <?php echo $this->Form->input('User.password', array('type'=>'text', 'class'=>'span4 m-wrap', 'label'=>false, 'div'=>false)); ?>
										</div>
									</div>
									<?php } ?>
									<div class="control-group">
